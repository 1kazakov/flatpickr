...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function createYearInput() {
        var wrapper = createElement("div", "numYearWrapper"), numInput = createElement("input", "cur-year");
        numInput.type = "text";
        numInput.pattern = "\\d*";
        numInput.tabIndex = -1;
    ...
    function FlatpickrInstance(element, instanceConfig) {
        ...
        function build() {
            ...
            // For mobile added wrapper and header with close cross button (HT)
            if (self.isMobileUserAgent) {
                var headerWithCloseButton = createElement("div", "flatpickr-close");
                bind(headerWithCloseButton, "click", self.close);
                self.calendarContainer.appendChild(headerWithCloseButton);
            }
                ...
                var _loop_1 = function (i, l) {
                    ...
                    if (elem !== undefined) {
                        ...
                        if (initialDate < hoverDate && timestamp === initialDate) {
                            ...
                            self.daysContainer.classList.remove("singleRange");
                        }
                            ...
                            self.daysContainer.classList.add("singleRange");
                        }
        ...
        function parseConfig() {
            ...
            self.isMobileUserAgent = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
            self.isMobile =
